...
export const Route = createFileRoute("/project-detail")({
  ...
  head: () => ({
    meta: [
      { title: "Project Details | Anantha Builders | Luxury Construction & Real Estate" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Project Details | Anantha Builders" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8">
              ...
              <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 leading-tight">
                Tadepalligudem Luxury Apartments
              </h1>
              
              {/* Project Description */}
              <div className="mt-6 space-y-4 text-base sm:text-lg leading-relaxed text-slate-600">
                <p>
                  Anantha Builders presents luxury residential apartments at Tadepalligudem, crafted with uncompromised engineering quality, RERA approvals, and modern architectural elegance.
                </p>
                <p>
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white rounded-[12px] p-6 border border-slate-200 shadow-sm flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-slate-600 mt-1 font-semibold">Tadepalligudem, AP</p>
                </div>
              </div>
